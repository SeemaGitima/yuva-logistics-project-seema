...
│       # Week 1 exploration notebook (data overview, quality checks, KPIs)
│
├── scripts/
...
│       # Week 4: Regression and classification modeling
│
├── outputs/
│   └── charts/
...
│       # Weekly Word-document reports submitted per task requirements
│
├── docs/
│   └── findings_summary.md
...
```text
notebooks/E-Commerce_Order_Fulfillment_Analysis.ipynb
```

**Report:**

```text
reports/Week1_Strategic_Planning_Report.docx
```
...
```text
reports/Week2_Data_Cleaning_Report.docx
```
...
```text
reports/Week3_EDA_Visualization_Report.docx
```
...
* Ship Processing Time
* Delayed Orders / Delay Rate
* Average Shipping Cost
* Delivered Orders / Delivery Success Rate
* Returned Orders / Return Rate
...
* Model evaluation (MAE, RMSE, R², Accuracy, F1)
* Interpretation of results

**Report:**

```text
reports/Week4_Predictive_Modeling_Report.docx
```
...
| ------------------------------ | --------: |
| Total Orders                   |    50,000 |
| Average Delivery Days (transit)| 5.99 days |
